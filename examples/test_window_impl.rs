...
CTRL+click on individual component to input value.\n",
        ...
        if CollapsingHeader::new("Popups & Modal windows").build(&ui) {
            ...
            TreeNode::new("Modals").build(&ui, || {
                ...
                ui.popup_modal("Delete?").always_auto_resize(true).build(ui, || {
                ...
                ui.popup_modal("Stacked 1").build(ui,|| {
                    ui.text(
                    ...
                    ui.popup_modal("Stacked 2").build(ui, || {
...
fn show_example_menu_file<'a>(ui: &Ui, state: &mut FileMenuState) {
    ...
    if let Some(_) = ui.begin_menu("Disabled") {
        unreachable!();
    }
...
output your content because that would create a feedback loop.",
            ...
            Slider::new("Number of lines", 1, 20)
